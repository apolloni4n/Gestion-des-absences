...
?>
  ...
  <body>
    ...
    <div class="container3">
      ...
      </center><br /> <strong>Le gestionnaire des absences est un service qui relève de l'Ensias ,
        <br />réalisé par les étudiants pour les étudiants. <br />Il a pour mission principale d'organniser le service d'absence au sein de l'école.</strong>
    </div>
